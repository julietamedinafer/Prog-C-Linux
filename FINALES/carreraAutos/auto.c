...
int main(int argc,char * argv[]){ 
	...
	/* reservar memoria */
	id_hilo= (pthread_t *)malloc(sizeof(pthread_t)*cant_autos);
	datos_th= (DatosAuto *)malloc(sizeof(DatosAuto)*cant_autos);
